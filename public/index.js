...
function calculate(mode) {
    ...
    if (atthp == 123) {
        ...
        if (defhp == 0) {
            ...
            entries = defhp;
            if (extinfo.length == 0) {
                document.getElementById("extendedinfo").innerHTML =
                    "<span style='border-top: 1px dashed black; padding-top: 10px; display: block; max-width: 350px;'></span><span class='ext'>Battle history does not contain any entries yet.</span>";
            }
            scrollanchor.scrollIntoView(false);
        }
    }
    if (mode != "Multi" && warning != true) {
        if (
            ...
            att % 0.5 != 0 ||
            def % 0.5 != 0 ||
            document.getElementById("attackhp").value % atthp != 0 ||
            document.getElementById("defensehp").value % defhp != 0 ||
            document.getElementById("attackmaxhp").value % attmaxhp != 0 ||
            document.getElementById("defensemaxhp").value % defmaxhp != 0
        ) {
            warning = true;
            messageclear();
    ...
    if (warning != true) {
        ...
        if (testdef == true) {
            if (defname == "Catapult") {
                document.getElementById("note").innerHTML =
                    "Note: Catapults can't benefit any from defense bonuses due to their 0 defense value!";
                ...
                document.getElementById("note").innerHTML =
                    "Note: Nature Bunnies can't capture cities and don't have any defensive technologies! Defense bonus was disregarded in the result.";
            } else {
                defforce = defforce * 1.5;
                defbonus = "|D";
            }
        ...
        if (testdef == true) {
            if (defname == "Boat" || defname == "Ship" || defname == "Battleship") {
                document.getElementById("note").innerHTML =
                    "Note: Ships can't benefit from walls! Wall bonus was disregarded in the result.";
            } else if (defname == "Catapult") {
                document.getElementById("note").innerHTML =
                    "Note: Catapults can't benefit from any defense bonuses due to their 0 defense value!";
            } else if (defname == "Mind Bender") {
                document.getElementById("note").innerHTML =
                    "Note: Mind Benders don't receive the defense bonus from cities! Wall bonus was disregarded in the result.";
            } else if (defname == "Giant") {
                document.getElementById("note").innerHTML =
                    "Note: Giants don't receive the defense bonus from cities! Wall bonus was disregarded in the result.";
            } else if (defname == "Navalon") {
                document.getElementById("note").innerHTML =
                    "Note: Navalons don't receive the defense bonus from cities! Wall bonus was disregarded in the result.";
            } else if (defname == "Baby Dragon") {
                document.getElementById("note").innerHTML =
                    "Note: Baby Dragons don't receive the defense bonus from cities! Wall bonus was disregarded in the result.";
            } else if (defname == "Fire Dragon") {
                document.getElementById("note").innerHTML =
                    "Note: Fire Dragons don't receive the defense bonus from cities! Wall bonus was disregarded in the result.";
            } else if (defname == "Crab") {
                document.getElementById("note").innerHTML =
                    "Note: Crabs don't receive the defense bonus from cities! Wall bonus was disregarded in the result.";
            } else if (defname == "Mooni") {
                document.getElementById("note").innerHTML =
                    "Note: Moonies don't receive the defense bonus from cities! Wall bonus was disregarded in the result.";
            } else if (defname == "Battle Sled") {
                document.getElementById("note").innerHTML =
                    "Note: Battle Sleds don't receive the defense bonus from cities! Wall bonus was disregarded in the result.";
            } else if (defname == "Ice Fortress") {
                document.getElementById("note").innerHTML =
                    "Note: Ice Fortresses don't receive the defense bonus from cities! Wall bonus was disregarded in the result.";
            } else if (defname == "Gaami") {
                document.getElementById("note").innerHTML =
                    "Note: Gaamis don't receive the defense bonus from cities! Wall bonus was disregarded in the result.";
            } else if (defname == "Nature Bunny") {
                document.getElementById("note").innerHTML =
                    "Note: Nature Bunnies can't capture cities! Wall bonus was disregarded in the result.";
            } else {
                defforce = defforce * 4;
                defbonus = "|W";
            }
        ...
        if (attname == "Fire Dragon") {
            ...
            if (splashhp > 0) {
                if (mode != "Multi") {
                    cstring = document.getElementById("resultsplash").innerHTML =
                        "<p><i>IF SPLASHED:</i></p>Defender survives! Remaining HP:  " + splashhp;
                    ...
                    if (document.getElementById("noretalbox").checked == true) {
                        cstring = document.getElementById("resultsplash").innerHTML =
                            "<i><p>Fire Dragon's main attack.</p>No enemy retaliation.</i>";
                    } else {
                ...
                if (mode != "Multi") {
                    cstring = document.getElementById("resultsplash").innerHTML =
                        "<p><i>IF SPLASHED:</i></p>Defender is DESTROYED! Afterlife HP:  " + splashhp;
                } else if (attackers[attackerselected].defendersattacked.length > 0) {
                    cstring = document.getElementById("resultsplash").innerHTML = "<i>Fire Dragon's splash attack.</i>";
                } else if (attackers[attackerselected].defendersattacked.length < 1) {
                    if (document.getElementById("noretalbox").checked == true) {
        ...
        if (mode == "Multi") {
            ...
            if (
                attackers[attackerselected].type != "Knight" &&
                attackers[attackerselected].type != "Navalon" &&
                attackers[attackerselected].type != "Fire Dragon"
            ) {
            ...
            document.getElementById("attacker" + attackerselected).innerHTML =
                "<img src='Attackers/" +
                attackers[attackerselected].type +
                ".png' height='55' width='55'><div id='splash" +
                attackerselected +
                "' style='position: absolute; top: 1px; right: 1px'><b>" +
                splashindicator +
                "</b></div><div style='position: absolute; width: 100%; bottom: 2px; text-align: center'>" +
                decshort +
                "/" +
                attackers[attackerselected].hp +
                "/" +
                attackers[attackerselected].maxhp +
                "</div>";
            ...
            document.getElementById("defender" + defenderselected).innerHTML =
                "<img src='Defenders/" +
                defenders[defenderselected].type +
                ".png' height='55' width='55'><div style='position: absolute; top: 1px; right: 1px'><b>" +
                defenders[defenderselected].defbonus +
                "</b></div><div style='position: absolute; width: 100%; bottom: 2px; text-align: center'>" +
                defenders[defenderselected].d +
                "/" +
                defenders[defenderselected].hp +
                "/" +
                defenders[defenderselected].maxhp +
                "</div>";
        ...
        if (
            ...
            defenders[defenderselected].hp > 0
        ) {
            cstring = document.getElementById("resultsplash").innerHTML = "<i>No enemy retaliation.</i>";
        }
        if (mode == "Multi") {
            if (
                attackers[attackerselected].type == "Archer" ||
                attackers[attackerselected].type == "Catapult" ||
                attackers[attackerselected].type == "Boat" ||
                attackers[attackerselected].type == "Ship" ||
                attackers[attackerselected].type == "Battleship" ||
                attackers[attackerselected].type == "Tridention" ||
                attackers[attackerselected].type == "Ice Fortress"
            ) {
        ...
        extinfo.splice(
            0,
            0,
            "<span style='border-top: 1px dashed black; display: block; max-width: 350px;'></span><p class='ext'>" +
                unit1 +
                unit2 +
                "</p><p class='ext'>" +
                astring +
...
function clickImage() {
    ...
    var tmp = this.previousElementSibling;
    while (tmp) {
    ...
    this.parentElement.value = this.getAttribute("alt");
}

function attackerfill() {
    clickImage.bind(this)();

    var getattacker = document.getElementById("selectattacker").value;

    var attackHints = document.querySelectorAll("span.attackhint");
    for (var i in attackHints) {
        attackHints[i].innerText = " (" + getattacker + ")";
    }
    ...
    if (
        getattacker == "Warrior" ||
        getattacker == "Rider" ||
        getattacker == "Defender" ||
        getattacker == "Swordsman" ||
        getattacker == "Archer" ||
        getattacker == "Catapult" ||
        getattacker == "Knight" ||
        getattacker == "Amphibian" ||
        getattacker == "Tridention" ||
        getattacker == "Battle Sled" ||
        getattacker == "Ice Fortress"
    ) {
...
function defenderfill() {
    ...
    var defenseHints = document.querySelectorAll("span.defensehint");
    for (var i in defenseHints) {
        defenseHints[i].innerText = " (" + getdefender + ")";
    }
    ...
    if (
        ...
        getdefender == "Swordsman" ||
        getdefender == "Archer" ||
        getdefender == "Catapult" ||
        getdefender == "Knight" ||
        getdefender == "Amphibian" ||
        getdefender == "Tridention" ||
        getdefender == "Battle Sled" ||
        getdefender == "Ice Fortress"
    ) {
...
function numberfocus(focusid) {
    ...
    if (shortparameter == true || document.getElementById("multibutton").innerText == "Single") {
        if (focusid == "attackhp") {
            ...
            document.getElementById("defensehprem").innerText =
                "(" + savednumber + "/" + document.getElementById("defensemaxhp").value + ")";
        }
    } else {
...
function multiswitch() {
    if (document.getElementById("multibutton").innerText == "Multi") {
        ...
        document.getElementById("def1").checked = false;
        document.getElementById("def2").checked = false;
        document.getElementById("selectattacker").firstElementChild.onclick();
        document.getElementById("attshiphp" + prevattshiphp).style.border = "1px solid #A9A9A9";
        document.getElementById("attshiphp" + prevattshiphp).style.backgroundColor = "";
        prevattshiphp = 10;
        document.getElementById("defshiphp" + prevdefshiphp).style.border = "1px solid #A9A9A9";
        document.getElementById("defshiphp" + prevdefshiphp).style.backgroundColor = "";
        prevdefshiphp = 10;
        attackerfill.bind(document.querySelector("#selectattacker img"))();
        document.getElementById("selectdefender").firstElementChild.onclick();
        defenderfill.bind(document.querySelector("#selectdefender img"))();
        document.getElementById("unitselect").innerText = "Create Defender";
        choosetype();
        document.body.scrollTop = document.documentElement.scrollTop = 0;
        resetcounters();
...
function createunit() {
    ...
    if (document.getElementById("unitselect").innerText == "Create Attacker" && warning != true) {
        ...
        attackerlist.insertAdjacentHTML(
            "beforeend",
            "<div class ='c' id='attacker" +
                i +
                "' style='width: 56px; height: 80px; border-style: solid; border-color: " +
                color +
                "; display: inline-block; position: relative' onclick='attackselector(" +
                i +
                ")'><img src='Attackers/" +
                attackers[i].type +
                ".png' height='55' width='55'><div style='position: absolute; width: 100%; bottom: 2px; text-align: center'>" +
                decshort +
                "/" +
                attackers[i].hp +
                "/" +
        ...
        if (defname == "Boat" || defname == "Ship" || defname == "Battleship") {
            ...
            if (defindicator == "W") {
                if (defname == "Catapult") {
                    ...
                    document.getElementById("note").innerHTML =
                        "Note: " + defname + "es don't receive the defense bonus from cities! Wall bonus was disregarded.";
                    defindicator = "";
                } else {
                    document.getElementById("note").innerHTML =
                        "Note: " + defname + "s don't receive the defense bonus from cities! Wall bonus was disregarded.";
                    defindicator = "";
                }
            ...
            if (defindicator == "W") {
                ...
                document.getElementById("note").innerHTML =
                    "Nature bunnies can't capture cities and don't have any defensive technologies! Defense bonus was disregarded.";
                defindicator = "";
            }
        }
        defenders.push({ type: defname, d: def, hp: defhp, maxhp: defmaxhp, defbonus: defindicator, frozen: false });
        var i = defenders.length - 1;
        defenderlist.insertAdjacentHTML(
            "beforeend",
            "<div class ='c' id='defender" +
                i +
                "' style='width: 56px; height: 80px; border-style: solid; border-color: " +
                color +
                "; display: inline-block; position: relative' onclick='defenseselector(" +
                i +
                ")'><img src='Defenders/" +
                defenders[i].type +
                ".png' height='55' width='55'><div style='position: absolute; top: 1px; right: 1px'><b>" +
                defenders[i].defbonus +
                "</b></div><div style='position: absolute; width: 100%; bottom: 2px; text-align: center'>" +
                defenders[i].d +
                "/" +
                defenders[i].hp +
...
function deleteunitprompt() {
    ...
    if (attackers.length < 1 && defenders.length < 1 && deleteselected == false) {
        ...
        messageclear();
        document.getElementById("resultatt").innerHTML =
            "Select units to delete them. Tap or click the Delete Units button again to stop deleting.";
...
function healunitprompt() {
    ...
    if (attackers.length < 1 && defenders.length < 1 && healselected == false) {
        ...
        messageclear();
        document.getElementById("resultatt").innerHTML =
            "Select units to heal them for +2 HP. You can select the same unit any number of times. Tap or click the +2 button again to stop healing.";
    ...
    if (deleteselected == true) {
        ...
        if (prevattackerselected != -2 && prevattackerselected != attackerselected) {
            ...
            if (attackers[prevattackerselected].unavailable == true) {
                ...
                attackers[prevattackerselected].type == "Fire Dragon" &&
                attackers[prevattackerselected].defendersattacked.length > 0
            ) {
                var splashindicator = "";
                var decshort = attackers[prevattackerselected].a;
                attackers[prevattackerselected].unavailable = true;
                document.getElementById(divselected).style.borderColor = "gray";
                document.getElementById("attacker" + prevattackerselected).innerHTML =
                    "<img src='Attackers/" +
                    attackers[prevattackerselected].type +
                    ".png' height='55' width='55'><div id='splash" +
                    prevattackerselected +
                    "' style='position: absolute; top: 1px; right: 1px'><b>" +
                    splashindicator +
                    "</b></div><div style='position: absolute; width: 100%; bottom: 2px; text-align: center'>" +
                    decshort +
                    "/" +
                    attackers[prevattackerselected].hp +
                    "/" +
                    attackers[prevattackerselected].maxhp +
                    "</div>";
            } else {
                document.getElementById(divselected).style.borderColor = "black";
            }
        ...
        if (attackerselected == -1 && defenders[defenderselected].hp > 0 && defenders[defenderselected].frozen == false) {
            ...
            if (freezecounter == 1) {
                ...
                document.getElementById("resultatt").innerHTML =
                    ...
                    " [" +
                    (defenderselected + 1) +
                    "]. Press on the same defender two more times to confirm.";
                ...
                document.getElementById("resultatt").innerHTML =
                    ...
                    " [" +
                    (defenderselected + 1) +
                    "]. Press on the same defender one more time to confirm.";
            } else if (freezecounter == 3) {
                messageclear();
                freezecounter = 0;
                document.getElementById("resultatt").innerHTML =
                    "Defender " + defenders[defenderselected].type + " [" + (defenderselected + 1) + "] frozen!";
                defenders[defenderselected].frozen = true;
            ...
            if (freezecounter == 1) {
                ...
                freezecounter = 0;
                document.getElementById("resultatt").innerHTML =
                    "Defender " + defenders[defenderselected].type + " [" + (defenderselected + 1) + "] unfrozen!";
...
function createbackup() {
    ...
    if (attackers.length < 1 && defenders.length < 1) {
        ...
        if (
            attackerselected >= 0 &&
            attackers[attackerselected].type == "Fire Dragon" &&
            attackers[attackerselected].defendersattacked.length > 0
        ) {
            var splashindicator = "";
            var decshort = attackers[attackerselected].a;
            var divselected = "attacker" + attackerselected;
...
function refreshattackers() {
    ...
    if (availabilitycheck == false && refreshcounter == 0) {
        ...
        if (refreshcounter == 1) {
            messageclear();
            document.getElementById("resultatt").innerHTML =
                'Opting to refresh all valid attackers. Press "Attackers:" two more times to confirm.';
        } else if (refreshcounter == 2) {
            messageclear();
            document.getElementById("resultatt").innerHTML =
                'Opting to refresh all valid attackers. Press "Attackers:" one more time to confirm.';
